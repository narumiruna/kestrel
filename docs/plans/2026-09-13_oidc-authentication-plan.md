...
- [x] Rename Backend service, routes, wire types, provider key, configuration, logs, and tests from Pocket ID to generic OIDC; 168 unit tests and 9 e2e tests pass.
...
- [x] Backend lint, 168 unit tests, 9 e2e tests, typecheck, build, Prisma generation, and schema validation pass.
