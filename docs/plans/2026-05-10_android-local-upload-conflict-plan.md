...
- [x] Update `2026-05-10_android-local-library-plan.md`, `2026-05-10_android-cloud-sync-plan.md`, and `2026-05-10_product-roadmap-plan.md` checklists to point to this plan and mark place upload/conflict as the active first slice; verified by docs diff in PR #46 follow-up.
...
- [x] Route upload/conflict remains explicitly deferred to a follow-up plan or unchecked roadmap item, verified by docs update. _`2026-05-10_product-roadmap-plan.md`, `2026-05-10_android-local-library-plan.md`, and `2026-05-10_android-cloud-sync-plan.md` already point at this plan as the place-only first slice._
